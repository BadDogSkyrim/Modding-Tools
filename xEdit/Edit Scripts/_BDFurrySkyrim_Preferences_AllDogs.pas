...
begin
    ...
    BEGIN // ========== SKAAL ============
        ...
        SetSubrace('YASSkaalRaceChild', 'Skaal', 'NordRace', 'YASXebaRaceChild', 'DOG', 'KhajiitRace');
    ...
    { ================================== HIGH ELF ================================== }
    BEGIN
        SetRace('HighElfRace', 'YASSkaalRace', 'CAT', 'KhajiitRace');
        SetRace('HighElfRaceVampire', 'YASSkaalRaceVampire', 'CAT', 'KhajiitRaceVampire');
    end;

    { ================================== WOOD ELF ================================== }
    BEGIN
        SetRace('WoodElfRace', 'YASSkaalRace', 'CAT', 'KhajiitRace');
        SetRace('WoodElfRaceVampire', 'YASSkaalRaceVampire', 'CAT', 'KhajiitRaceVampire');
    end;

    { ================================== DARK ELF ================================== }
    BEGIN
        SetRace('DarkElfRace', 'YASKonoiRace', 'CAT', 'KhajiitRace');
        SetRace('DarkElfRaceVampire', 'YASKonoiRaceVampire', 'CAT', 'KhajiitRaceVampire');
    end;

    { ================================== ORC (MINO) ============================= }
    BEGIN
        SetRace('OrcRace', 'YASKonoiRace', 'MINO', 'KhajiitRace');
        SetRace('OrcRaceVampire', 'YASKonoiRaceVampire', 'MINO', 'KhajiitRaceVampire');
