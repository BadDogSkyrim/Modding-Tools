...
begin
    ...
    BEGIN
        ...
        // Lykaios Hair
        LabelHeadpartList('YASCanMaleHairDreads001', 'DREADS,BOLD,FUNKY');
        // LabelHeadpart('BDLykMaleHairDreads002', 'DREADS'); // Dark version
        LabelHeadpartList('YASCanMaleHairDreads003', 'DREADS,NOBLE,BOLD,FUNKY');
        // LabelHeadpart('BDLykMaleHairDreads004', 'DREADS'); // Dark version
        LabelHeadpartList('YASCanMaleHairDreadsFringe', 'DREADS,NOBLE,BOLD,FUNKY,YOUNG');
        LabelHeadpartList('YASCanMaleHairDreadsHeadband', 'DREADS,NOBLE,BOLD,FUNKY,FEATHERS');
        LabelHeadpartList('YASCanMaleHairFringeFlip001', 'YOUNG,SHORT');
        LabelHeadpartList('YASCanMaleHairLionMane001', 'MANE,LONG');
        LabelHeadpartList('YASCanMaleHairLionMane002', 'MANE,LONG,YOUNG');
        LabelHeadpartList('YASCanMaleHairLionManebraids', 'MANE,LONG,NOBLE,BRAIDS');
        LabelHeadpartList('YASCanMaleHairLionManeFringeLeftBraid', 'MANE,LONG,NOBLE,BRAIDS');
        LabelHeadpartList('YASCanMaleHairLionManeHeadband', 'MANE,LONG,NOBLE,FEATHERS');
        LabelHeadpartList('YASCanMaleHairLongBraid001', 'BRAIDS,NEAT,TIEDBACK,BRAIDS,NEAT');
        LabelHeadpartList('YASCanMaleHairLongBraid002', 'TIEDBACK,BRAIDS,NOBLE');
        LabelHeadpartList('YASCanMaleHairLongBraidleft', 'NEAT,TIEDBACK,BRAIDS,NOBLE');
        LabelHeadpartList('YASCanMaleHairMohawk001', 'MOHAWK,BRAIDS,MILITARY,BOLD');
        LabelHeadpartList('YASCanMaleHairMohawk003', 'MOHAWK,FEATHERS,BOLD');
        LabelHeadpartList('YASCanMaleHairMohawkFringe', 'MOHAWK,YOUNG,BOLD');
        LabelHeadpartList('YASCanMaleHairShaggyHair002', 'LONG,MESSY');
        LabelHeadpartList('YASCanMaleHairShaggyHair003', 'LONG,MESSY,FEATHERS');
        LabelHeadpartList('YASCanMaleHairShorCrop001', 'SHORT,NEAT');
        LabelHeadpartList('YASCanMaleHairShorCrop002', 'SHORT,NEAT,YOUNG');
        LabelHeadpartList('YASCanMaleHairShorCrop003', 'SHORT,NEAT,NOBLE');
        LabelHeadpartList('YASCanMaleHairShorCrop004', 'SHORT,NEAT,NOBLE,FEATHERS');
        LabelHeadpartList('YASCanMaleHairTiedStyle001', 'LONG,NOBLE,NEAT');
        LabelHeadpartList('YASCanMaleHairTiedStyleFringe', 'LONG,NOBLE,NEAT,YOUNG');
        LabelHeadpartList('YASCanMaleHairTiedStyleHeadband', 'LONG,NOBLE,NEAT,YOUNG,FEATHERS');
        LabelHeadpartList('YASCanMaleHairVanillaBraid001', 'LONG,NEAT,TIEDBACK');
        LabelHeadpartList('YASCanMaleHairVanillaCrop001', 'SHORT,YOUNG,MILITARY');
        LabelHeadpartList('YASCanMaleHairVanillaHair001', 'MESSY,LONG');
        LabelHeadpartList('YASCanMaleHairBeastSidehawk', 'MOHAWK,FUNKY,BOLD');
